...
| 18 | Structured code, clean components and state | Feature folders, standalone components, a single signal-based store per feature, typed HTTP services. 60 unit tests under `client/src/app`, run with `npm run test:ci` |
